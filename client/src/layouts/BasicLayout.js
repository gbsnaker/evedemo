      ...
      <Layout>
        ...
        >
          <div className={styles.logo}>
            <Link to="/">
              <img src="http://www.xiaoshouyi.com/wp-content/uploads/2016/10/logo-blue.png" alt="logo" />
              <h1> DevOPS</h1>
            </Link>
          </div>
          <Menu
        ...
        <Layout>
          ...
          <Content style={{ margin: '24px 24px 0', height: '100%' }}>
            ...
            <GlobalFooter
              ...
              copyright={
                <div>
                  Copyright <Icon type="copyright" /> 2018 devops for xsy
                </div>
              }
            />
          </Content>
